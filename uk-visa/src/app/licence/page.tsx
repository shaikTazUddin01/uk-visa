...
const LicencePage = () => {
  return (
    <div className="max-w-2xl mx-auto ">
      <h1 className="text-[8px] md:text-lg text-blue-950 font-bold my-3">
        Licence summary, applications and services
      </h1>

      <section className="mb-1 text-[8px] md:text-xs">
        <h2 className="text-[8px] md:text-xs font-bold text-blue-950 underline cursor-pointer mb-2">
          Manage Level 1 and 2 users
        </h2>
        <ul className="list-[square] list-inside mb-4 text-[8px] md:text-xs">
          <li>Add and deactivate SMS users</li>
          <li>Edit SMS user profiles</li>
        </ul>
        <Link
          href="#"
          className="text-blue-950 font-semibold  text-[8px] md:text-xs underline mt-6"
        >
