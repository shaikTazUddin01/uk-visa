...
const HomePage = () => {
  ...
  return (
    <div>
      <p className="text-blue-950 text-[8px] md:text-base font-bold">
        Sponsorship management system (SMS)
      </p>
      <p className="text-[8px] md:text-xs my-2">
      ...
      <Link
        href={"/login"}
        className="text-blue-950 underline text-[8px] md:text-xs font-bold"
      >
        Login
      </Link>
      ...
      <p className="underline text-[8px] md:text-xs text-blue-950 cursor-pointer mt-3">
