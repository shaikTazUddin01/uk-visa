...
const WorkerPage = () => {
  return (
    <div className="max-w-2xl mx-auto  text-[8px] md:text-xs">
      <h1 className=" text-[8px] md:text-lg text-blue-950 font-bold mt-3">Workers</h1>
      ...
      {worksData?.map((work, index) => (
        <section key={index} className="mb-1  text-[8px] md:text-xs">
          <Link href={work?.link} className="tex text-[8px] md:text-xs font-bold text-blue-950 underline cursor-pointer mb-2">
            {work?.title}
          </Link>
