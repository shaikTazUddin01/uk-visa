  ...
  return (
    <div className="min-h-screen">
      <div className="bg-white p-2">
        <h1 className="text-xl font-semibold mb-6 ">Online payment</h1>
        ...
        <div className="mt-5">
          <h2 className="text-xl font-medium text-gray-900 bg-gray-300 px-2 py-1.5 ">
            Payment amount
          </h2>
          <div className="space-y-1 mb-6 bg-gray-200 px-2">
            <div className="flex justify-between items-center px-2 pt-1 text-gray-800">
        ...
        <div className="text-right my-3 space-x-3">
          ...
          <button
            ...
            className={`px-2 p-1 md:text-xs font-semibold  transition-all duration-200
               bg-gradient-to-t from-[#10254E] to-[#496192] text-white "
                `}
          >
            Assign CoS
          </button>
