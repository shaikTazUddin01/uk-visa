      ...
      <div className="min-h-screen  px-2">
        <div className=" w-full">
          <div className="bg-gray-200">
            ...
            <h2 className="text-[8px] lg:text-lg font-semibold  text-gray-800 px-1">
              Application Summery
            </h2>
            <div className="mb-3 p-2 bg-gray-50 rounded-md border border-gray-200">
              <div className="grid grid-cols-1 md:grid-cols-1 gap-y-2 gap-x-4 text-[8px] lg:text-sm text-gray-700">
          ...
          {/* Information Text */}
          <p className="mb-3 text-[8px] lg:text-xs text-gray-700 leading-relaxed">
          ...
          <h2 className="text-[8px] lg:text-xl font-bold mb-4 text-gray-800">
            Defined CoS details
          </h2>
          <div className="-mt-4 lg:mt-0">
            <button
              onClick={() => router.push("/create-application")}
              className="px-2 p-1 bg-gradient-to-t from-[#10254E] to-[#496192] text-white text-[8px] lg:text-[13px] font-semibold"
            >
              Next
            </button>
          </div>

          <div className="flex justify-end mt-6 space-x-3"></div>
        </div>
      </div>
    </>
  );
